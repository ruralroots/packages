...
Any NetFlow compatible collector should work with Softflowd. A search for *NetFlow Analysis software* will yield multiple choices for various platforms, both commercial and open source.

Developer website	http://mindrot.org

Documentation: See Linux Man Pages - softlowd(8), softflowctl(8), bpf(4)
...
## **Softflowd/Softflowctl Available Runtime Commands**
    ...
    debugUp 	  ->  Increase softflowd Debug Verbosty
...
Commands can now be executed by entering:<br>`sf [command] [ctlsock] [option]`
...
* Show ***Statistics*** for the specified monitored flow:<br>`sf statistics wan`
...
* Display all ***Active*** Interfaces:    `sf active`
  ...
  * Reports all currently active interfaces and corresponding PIDs.
